...
import com.co.academia.handler.CursoHandler;
import com.co.academia.handler.EstudianteHandler;
import com.co.academia.handler.MatriculaHandler;
...
public class RouterConfig {
	...
	public RouterFunction<ServerResponse> rutasEstudiantes(EstudianteHandler handler) {
		return route(GET("/v2/estudiantes"), handler::listar)
				.andRoute(GET("v2/estudiantes/Ordenado"), handler::listarPorEdadDesendente)
